...
const Header = () => {
  ...
  const loginData = (!Cookies.get('Code_Maya_Assignment')) ? [] : JSON.parse(Cookies.get('Code_Maya_Assignment'));
          ...
          <a href="#" className="logo">
            <div className="logo-lg">
              <span className="dark-logo">
                <span style={{ fontSize: '25px', color: '#fff', marginLeft: '8px' }}> Admin Panel </span>
              </span>
            </div>
          </a>
        </div>
